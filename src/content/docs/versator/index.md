---
title: Get Started with Versator
description: This is the introduction of Versator.
---
...
<!-- 👉 https://github.com/blefnk/versator 🙏 -->
...
<p>
    <span>
      <a href="https://versator.com">
        <picture>
            <source media="(prefers-color-scheme: dark)" srcset="/screenshot-dark.png" />
            <source media="(prefers-color-scheme: light)" srcset="/screenshot-light.png" />
            <img alt="Shows the landing page of Versator Next.js template, with its logo and the phrase 'Versator Empowers Your eCommerce with the Power of Next.js'." src="/screenshot-light.png" width="40%" />
        </picture>
      </a>
    </span>
    <span>
    ...
    <span>
      <a href="https://versator.com">
        <picture>
            <source media="(prefers-color-scheme: dark)" srcset="/screenshot-dark.png" />
            <source media="(prefers-color-scheme: light)" srcset="/screenshot-light.png" />
            <img alt="Shows the landing page of Versator Next.js template, with its logo and the phrase 'Versator Empowers Your eCommerce with the Power of Next.js'." src="/screenshot-light.png" width="50%" />
        </picture>
      </a>
    </span>
    <span>
      <a href="https://star-history.com/#blefnk/versator&Timeline">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=blefnk/versator&type=Timeline&theme=dark" />
        <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=blefnk/versator&type=Timeline" />
        <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=blefnk/versator&type=Timeline" width="50%" />
      </picture>
      </a>
    </span>
</p> -->
